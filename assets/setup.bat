...
start /wait cmd /c "choco install -y msys2"
...
%CURRENT_DIR%utils\pathed /APPEND C:\tools\msys64\mingw64\bin /USER
%CURRENT_DIR%utils\pathed /APPEND C:\tools\msys64\usr\bin /USER